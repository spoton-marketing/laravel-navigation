...
use SpotOnMarketing\Navigation\Exceptions\ContainerException;
use SpotOnMarketing\Navigation\Navigation\Container;
...
class NavigationService implements NavigationServiceInterface
{
    ...
    /** @var string */
    protected $assertionClass = 'SpotOnMarketing\Assertions\Services\AssertionService';
