...
use SpotOnMarketing\Navigation\Options\ContainerOptions;
...
class Container implements ContainerInterface
{
    ...
    protected function validateAssertionService()
    {
        if (!$this->assertionService) {
            throw new IllegalConfigurationException(
                _('Please require SpotOnMarketing/assertions` to use assertions in your navigation')
            );
        }
    }
     ...
     * Render page
     *
     * @param \SpotOnMarketing\Navigation\Navigation\Page $page
     * @param null $maxDepth
     * @param int $depth
     * @return null|string
     * @throws \SpotOnMarketing\Navigation\Exceptions\NoRouteException
     */
