...
namespace SpotOnMarketing\NavigationTest\Options;

use PHPUnit_Framework_TestCase;

class PageOptionsTest extends PHPUnit_Framework_TestCase
{
    /** @var \SpotOnMarketing\Navigation\Options\PageOptions */
    protected $options;
    ...
    {
        $options = new \SpotOnMarketing\Navigation\Options\PageOptions($this->demoOptions);
